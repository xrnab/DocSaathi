        ...
        <Card className="border-sky-900/20">
          <CardHeader className="text-center">
            <div
              className={`mx-auto p-4 ${
                isRejected ? "bg-red-900/20" : "bg-sky-900/20"
          ...
          <CardContent className="text-center">
            {isRejected ? (
              ...
              <div className="bg-sky-900/10 border border-sky-900/20 rounded-lg p-4 mb-6 flex items-start">
                <AlertCircle className="h-5 w-5 text-sky-400 mr-3 mt-0.5 flex-shrink-0" />
