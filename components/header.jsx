  ...
  return (
    <>
      <header className="fixed top-4 left-0 right-0 z-50 px-2 sm:px-4 flex justify-center">
        <nav className="container max-w-7xl min-h-[4rem] flex items-center justify-between bg-background/70 backdrop-blur-xl border border-border shadow-lg shadow-sky-500/5 rounded-[2rem] px-4 sm:px-6 py-2 gap-2">
          <Link href="/" className="flex flex-col gap-0.5 cursor-pointer shrink-0">
            <div className="flex items-center gap-2">
              ...
              <span className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-sky-500 to-blue-700 dark:from-sky-400 dark:to-blue-500 tracking-tight overflow-hidden">
