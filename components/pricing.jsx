  ...
  const plans = [
    {
      ...
      price: 0,
      credits: 10,
      gradient: "from-slate-50 to-slate-100/50 dark:from-slate-900 dark:to-slate-950",
    ...
    },
    {
      ...
      price: 499,
      credits: 50,
      gradient: "from-sky-50/50 to-blue-50/50 dark:from-sky-950/40 dark:to-blue-950/50",
      border: "border-sky-200 dark:border-sky-800/60 shadow-sky-500/5",
    ...
    },
    {
      ...
      price: 999,
      credits: 150,
      gradient: "from-emerald-50/40 to-teal-50/40 dark:from-emerald-950/40 dark:to-teal-950/50",
      border: "border-emerald-200 dark:border-emerald-800/60 shadow-emerald-500/5",
