...
export default function NearbyDoctors() {
  ...
  return (
    <div className="absolute bottom-4 left-4 right-4 sm:bottom-6 sm:left-6 sm:right-auto max-w-sm w-auto sm:w-full animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-500 z-30">
      <div className={cn(
