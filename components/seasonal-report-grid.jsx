  ...
  if (!mounted) {
    return (
      <div className="w-full relative overflow-hidden">
        <div className="flex flex-row md:grid md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 overflow-x-auto md:overflow-visible no-scrollbar pb-10 pt-4 md:py-0 w-full">
